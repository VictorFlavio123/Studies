...
public class GameController : MonoBehaviour
{
    ...
    public void ResetPositionCamera()
    {
        ...
        main_camera.transform.localRotation = camInitialRotation;
        //main_camera.agenteyespos = false;
            //new Quaternion(39.31f, -180, 0, 0);
    }
    ...
    void Start()
    {
        ...
        else
        {
            ...
            camInitialRotation = main_camera.transform.localRotation;
