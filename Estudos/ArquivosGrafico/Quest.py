...
cam = df_video_data['CamPercepVariaVelo'].unique()
print(cam)
countCamPerspectiveDens = len(df_video_data[df_video_data['CameraPercepDensidade'] == cam[0]])
countCamEgocentricDens = len(df_video_data[df_video_data['CameraPercepDensidade'] == cam[1]])
countCamNHouveDens = len(df_video_data[df_video_data['CameraPercepDensidade'] == cam[2]])
trace = go.Pie(labels=cam, values=[countCamPerspectiveDens, countCamEgocentricDens, countCamNHouveDens])

countCamPerspectiveVariaVelo = len(df_video_data[df_video_data['CamPercepVariaVelo'] == cam[0]])
countCamEgocentricVariaVelo = len(df_video_data[df_video_data['CamPercepVariaVelo'] == cam[1]])
countCamNHouveVariaVelo = len(df_video_data[df_video_data['CamPercepVariaVelo'] == cam[2]])
trace2 = go.Pie(labels=cam, values=[countCamPerspectiveVariaVelo, countCamEgocentricVariaVelo, countCamNHouveVariaVelo])

countCamPerspectiveDist = len(df_video_data[df_video_data['CamPercepDistan'] == cam[0]])
countCamEgocentricDist = len(df_video_data[df_video_data['CamPercepDistan'] == cam[1]])
countCamNHouveDist = len(df_video_data[df_video_data['CamPercepDistan'] == cam[2]])
trace3 = go.Pie(labels=cam, values=[countCamPerspectiveDist, countCamEgocentricDist, countCamNHouveDist])

countCamPerspectiveDir = len(df_video_data[df_video_data['CamMudanDedir'] == cam[0]])
countCamEgocentricDir = len(df_video_data[df_video_data['CamMudanDedir'] == cam[1]])
countCamNHouveDir = len(df_video_data[df_video_data['CamMudanDedir'] == cam[2]])
trace4 = go.Pie(labels=cam, values=[countCamPerspectiveDir, countCamEgocentricDir, countCamNHouveDir])
...
fig = {
  "data": [
    {
      "values": [countCamPerspectiveDens, countCamEgocentricDens, countCamNHouveDens],
      "labels": [cam[0], cam[1], cam[2]],
      "domain": {'x': [0, .48],
                       'y': [0, .49]},
      "name": "Density Perception",
      "hoverinfo":"label+percent+name",
      "hole": .4,
      "type": "pie"
    },
    {
      "values": [countCamPerspectiveVariaVelo, countCamEgocentricVariaVelo, countCamNHouveVariaVelo],
      "labels": [cam[0], cam[1], cam[2]],
      "text":[""],
      "textposition":"inside",
      "domain": {'x': [.52, 1],
                       'y': [0, .49]},
      "name": "Perception of Velocity Variation",
      "hoverinfo":"label+percent+name",
      "hole": .4,
      "type": "pie"
    },
    {
      "values": [countCamPerspectiveDist, countCamEgocentricDist, countCamNHouveDist],
      "labels": [cam[0], cam[1], cam[2]],
      "domain": {'x': [0, .48],
                       'y': [.51, 1]},
    ...
    {
      "values": [countCamPerspectiveDir, countCamEgocentricDir, countCamNHouveDir],
      "labels": [cam[0], cam[1], cam[2]],
      "text":[""],
      "textposition":"inside",
      "domain": {'x': [.52, 1],
