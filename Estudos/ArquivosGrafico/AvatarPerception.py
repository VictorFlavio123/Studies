...
fig = {
  "data": [
    {
      "values": [countavatarPerspectiveDens, countavatarEgocentricDens, countavatarNHouveDens],
      "labels": [avatar[0], avatar[1], avatar[2]],
      "domain": {'x': [0, .48],
                       'y': [0, .49]},
    ...
    {
      "values": [countavatarPerspectiveVariaVelo, countavatarEgocentricVariaVelo, countavatarNHouveVariaVelo],
      "labels": [avatar[0], avatar[1], avatar[2]],
      "text":[""],
      "textposition":"inside",
      "domain": {'x': [.52, 1],
    ...
    {
      "values": [countavatarPerspectiveDist, countavatarEgocentricDist, countavatarNHouveDist],
      "labels": [avatar[0], avatar[1], avatar[2]],
      "domain": {'x': [0, .48],
                       'y': [.51, 1]},
